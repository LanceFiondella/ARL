# -*- coding: utf-8 -*-
"""
Created on Fri Mar 31 17:30:34 2017
...
class CanvasTemplate(FigureCanvas):
    ...
    def __init__(self, parent=None, width=5, height=4, dpi=100):
        ...
        self.mpl_connect('motion_notify_event', self.on_release)
...
class reliFleet_graph(CanvasTemplate):
    ...
    def mouse_moved(self, mouse_event):
        if mouse_event.inaxes:
            ...
            self.txt=mouse_event.inaxes.text(x,y,'(%f,%f)'%(x,y),bbox=bbox)
            mouse_event.canvas.draw()
